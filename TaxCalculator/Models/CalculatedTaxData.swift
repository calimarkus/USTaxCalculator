...
public struct FederalTaxData {
    ...
    public init(taxes: [BasicTax],
                totalTaxableIncome: Double,
                totalTaxes: Double,
                deduction: Deduction,
                withholdings: Double,
                credits: Double,
...
public struct StateTaxData {
    ...
    public init(state: TaxState,
                attributableIncome: AttributableIncome,
                taxes: [AttributableTax],
                localTax: BasicTax? = nil,
                taxableStateIncome: NamedValue,
                additionalStateIncome: Double,
                deduction: Deduction,
                withholdings: Double,
                credits: Double,
                summary: TaxSummary)
...
public struct CalculatedTaxData: Identifiable, Hashable {
    ...
    public init(inputData: TaxDataInput,
                federalData: FederalTaxData,
                stateTaxDatas: [StateTaxData],
                statesSummary: TaxSummary,
